...
while true
  ...
  set var.debugOn = false  ; Here to change while running
  if var.debugOn
  ...
  if exists(global.shuttingDown) && global.shuttingDown == true
    M150 E0 R0 U0 B255 P255 S144	; blue
  elif state.status == "starting"
    M150 E0 R255 U70 B0 P255 S144  ; orange
  elif state.status == "disconnected"
    M150 E0 R255 U70 B0 P255 S144  ; orange
  elif state.status == "idle"
    M150 E0 R0 U255 B0 P255 S144  ; green
	...
	M150 E0 R255 U0 B0 P255 S144	; red
  else
    M150 E0 R255 U70 B0 P255 S144  ; orange
